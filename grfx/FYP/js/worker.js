...
var groundShape = new Ammo.btBoxShape(new Ammo.btVector3(500, 500, 500));

var bodies = [];

var groundTransform = new Ammo.btTransform();
groundTransform.setIdentity();
groundTransform.setOrigin(new Ammo.btVector3(0, -500, 0));
...
var boxSize = 5;
var boxShape = new Ammo.btBoxShape(new Ammo.btVector3(boxSize, boxSize, boxSize));
  ...
  for (var x = 0; x < side; x++) {
    for (var y = 0; y < side; y++) {
      for (var z = 0; z < side; z++) {
        ...
        origin.setX((x - side/2)*((5*boxSize) * Math.random()));
        origin.setY(((y+1) * ((5*boxSize) * Math.random())));
        origin.setZ((z - side/2)*((5*boxSize) * Math.random()) - side - 3);
        body.activate();
